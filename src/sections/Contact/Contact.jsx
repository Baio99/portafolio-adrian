...
const socialIconVariants = {
  ...
  visible: {
    opacity: 1,
    scale: 1,
    transition: { type: 'spring', stiffness: 240, damping: 5 }
  },
  hover: {
    scale: 1.2,
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_owp7dui', 'template_mec7kw8', formData, 'wBi-wq0LLBdD8nPXN')
      .then(() => {
  ...
  return (
    ...
    >
      ...
      <motion.div className="contact-container" variants={containerVariants}>
        ...
        >
          <motion.h3 variants={itemVariants}>{t('contact.heading')}</motion.h3>
          <motion.p variants={itemVariants}>{t('contact.description')}</motion.p>
